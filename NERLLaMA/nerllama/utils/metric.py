...
from nerllama.utils.train_utils import MODEL_INPUT_TEMPLATE
...
def extract_classes(input_string: str, entity_types: list[str]) -> dict[str, str]:
    ...
    input_string = input_string[
                   answer_start_idx + output_separator_length + 1:]  # input string should start with class tag
